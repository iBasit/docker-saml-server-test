...
-p 8081:8080 \
-e SIMPLESAMLPHP_SP_ENTITY_ID=http://sso.circusstreet.localhost/metadata.xml \
-e SIMPLESAMLPHP_SP_ASSERTION_CONSUMER_SERVICE=http://localhost:8081/simplesaml/module.php/saml/sp/saml2-acs.php/test-sp \
-e SIMPLESAMLPHP_SP_SINGLE_LOGOUT_SERVICE=http://localhost:8081/simplesaml/module.php/saml/sp/saml2-logout.php/test-sp \
